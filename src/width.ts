 ...
 * @returns boolean
 */
export function useGreaterThan(against: number): boolean {

	// State
	const [ result, resultSet] = useState<boolean>(
		document.documentElement.clientWidth > against
	);
 ...
 * @returns boolean
 */
export function useLessThan(against: number): boolean {
